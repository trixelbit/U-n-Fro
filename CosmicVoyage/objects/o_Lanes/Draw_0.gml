...
matrix_set(matrix_world,matrix_build(o_Player.x-1024,o_Player.y-2048,90,0,0,0,2048,2048,2048))
vertex_submit(vertexQuad,pr_trianglelist,sprite_get_texture(t_SurfacePlanet,0))

matrix_set(matrix_world,matrix_build(o_Player.x-1024,o_Player.y-2048,72,0,0,0,2048,2048,2048))
